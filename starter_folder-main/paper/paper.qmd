...
# Display the summary statistics table in a vertically aligned format
kbl(summary_stats, col.names = c("Variable", "Mean", "SD", "Min", "Median", "Max")) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"), 
                full_width = F, 
                position = "center", 
                font_size = 10) %>%
...
# Result-Data Visualization {#third-result}
## Turbidity across different beach {#third1-result} 
@fig-box1 provides a clear visualization of the distribution of turbidity across various beach locations. Bluffer's Beach Park, Kew Balmy Beach, and Cherry Beach appear to have the highest overall turbidity levels, with numerous outliers reaching above 50 NTU and some exceeding 100 NTU. Hanlan’s Point Beach, Ward’s Island Beach, Gibraltar Point Beach, and Centre Island Beach exhibit much lower turbidity levels overall. Other beaches are showing more variability than low-turbidity beaches but less than the higher-turbidity ones.
```{r}
#| echo: false
#| eval: true
#| warning: false
...
## Relationship between Air Temperature and Turbidity {#third2-result} 
...
## Relationship between Water Temperature and Turbidity {#third3-result} 
...
## Relationship between Wind Speed and Turbidity{#third4-result} 
...
## Relationship between Waterfowl Count and Turbidity{#third5-result} 
...
## Turbidity Levels on Rainy vs. Non-Rainy Day{#third6-result} 
...
# Discussion{#fourth-dis}
## Impacts of beach location on water quality{#fourth1-dis}
...
## Impact of Rainfall on Water Quality{#fourth2-dis}
...
## The Role of Waterfowl in Turbidity{#fourth3-dis}
...
## Wind speed and its effect on turbidity{#fourth4-dis}
...
## Temperature and Turbidity{#fourth5-dis}
...
## Data Limitations and future improvement{#fourth6-dis}
