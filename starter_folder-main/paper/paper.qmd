---
title: "Water Quality and Safety at Toronto Beaches"
subtitle: "A Data-Driven Investigation into Seasonal Trends and Public Health Implications"
author: 
  - Ziyuan Shen
...
#| message: false
#| label: fig-his2
#| fig-cap: "Distribution of water temperature"

# 5.Histogram: Distribution of water temperature
water_temp_hist <- ggplot(cleaned_data, aes(x = waterTemp)) +
  geom_histogram(binwidth = 20, fill = "blue", color = "black") +
  labs(x = "Water Temperature (°C)", y = "Count") +
  theme_minimal()

# Print plot and caption
print(water_temp_hist)
